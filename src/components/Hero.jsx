    ...
    <section class={styles.hero}>
      ...
      <div class={`${styles.statsLeft} ${visible ? styles.visible : ''}`}>
        <div class={styles.statBlock}>
          ...
          <span class={styles.statLabel}>Créateur de contenus IA</span>
        </div>
      ...
      <div class={`${styles.content} ${visible ? styles.visible : ''}`}>
        ...
        <h1 class={styles.title}>{FEATURED.title} GenAI</h1>
        ...
        <div class={styles.trailerCard}>
          <div class={styles.trailerThumb}>
            <img src={FEATURED.trailer} alt="Trailer" />
          ...
          <div class={styles.trailerInfo}>
            <span class={styles.trailerLabel}>REGARDER L'original</span>
            <span class={styles.trailerDur}>11,30 min</span>
